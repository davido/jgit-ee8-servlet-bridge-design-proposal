...
Gitiles' `.ee10` flavour from one rule. This is no longer hypothetical:
Gitiles' EE10 (`jakarta.servlet`) flavour, generated by that same transform, is
already published for review
